package com.example.projekti_painscale_activity;
...
public class MainActivityNoriin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        move.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityNoriin.this, painArea.class );
